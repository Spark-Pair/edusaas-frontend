  ...
  return (
    <div className="fade-in">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button onClick={openAddModal} title="Add a student">
                  ...
                  <tr key={student._id} className="fade-in">
                    ...
                    <td>
                      <div className="flex items-center gap-1">
                        <Button size="sm" variant="ghost" onClick={() => openEditModal(student)} title={`Edit ${student.firstName} ${student.lastName}`}>Edit</Button>
      ...
      <Modal
        ...
        size="xl"
      >
        <form onSubmit={handleSubmit} className="flex h-[560px] -m-5">
